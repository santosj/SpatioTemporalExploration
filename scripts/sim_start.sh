...
tmux send-keys "source ~/simulation_ws/devel/setup.bash; DISPLAY=:0 roslaunch mongodb_store mongodb_store.launch db_path:=$HOME/mongodb_store"

tmux select-window -t $SESSION:2
tmux send-keys "source ~/simulation_ws/devel/setup.bash; DISPLAY=:0 roslaunch strands_morse uol_ww_morse.launch"

tmux select-window -t $SESSION:3
tmux send-keys "source ~/simulation_ws/devel/setup.bash; DISPLAY=:0 roslaunch strands_morse uol_ww_nav2d.launch"

tmux select-window -t $SESSION:4
tmux send-keys "source ~/simulation_ws/devel/setup.bash; DISPLAY=:0 roslaunch strands_morse generate_camera_topics.launch"

tmux select-window -t $SESSION:5
tmux send-keys "source ~/simulation_ws/devel/setup.bash; DISPLAY=:0 roslaunch strands_ui strands_ui.launch"
