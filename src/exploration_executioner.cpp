...
#include <spatiotemporalexploration/Information.h>
...
ros::Publisher *reach_pub_ptr, *info_pub_ptr;
...
int main(int argc,char *argv[])
{
    ...
    ros::Publisher info_pub = nh.advertise<spatiotemporalexploration::Information>("/gathered_info", 10);
